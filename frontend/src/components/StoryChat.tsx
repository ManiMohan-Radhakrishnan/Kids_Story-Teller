...
import { Send, RotateCcw, Settings, CheckCircle, MessageCircle, Sparkles, Mic, MicOff, Loader2 } from 'lucide-react';
      ...
      >
        <div className="flex items-center space-x-4">
          <div className="flex items-center">
            <div className="w-10 h-10 rounded-full bg-purple-50 flex items-center justify-center text-purple-400 mr-3">
          ...
          <div className="hidden sm:flex items-center space-x-2 text-sm text-muted-foreground">
            <span className="font-medium">{totalWordCount} words</span>
            ...
            <div className="bg-white/70 backdrop-blur-sm p-6 rounded-[2rem] shadow-sm border border-white">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                <div className="space-y-1">
                  <p className="font-medium text-muted-foreground">Content Filter</p>
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-primary font-semibold">{state.ageGroup} years</p>
                </div>
                <div className="space-y-1">
                  <p className="font-medium text-muted-foreground">Messages</p>
                  <p className="text-primary font-semibold">{state.messageCount} exchanges</p>
                </div>
              </div>
            </div>
          </motion.div>
          ...
          >
            ...
            {state.userInputs[index - 1] && (
              <div className="flex justify-end mb-4">
                <div className="max-w-md bg-gradient-to-r from-blue-500 to-purple-600 text-white p-4 rounded-2xl rounded-br-sm shadow-sm">
              ...
              <div className="flex items-start space-x-3">
                ...
                <div className="flex-1">
                  <div className="flex items-center justify-between mb-3">
                    <h3 className="font-heading font-bold text-foreground/80">Story Narrator</h3>
        ...
        {state.isComplete && (
          ...
          >
            <div className="inline-flex items-center space-x-2 bg-gradient-to-r from-green-50 to-emerald-50 border-2 border-green-200 rounded-2xl px-6 py-4">
              ...
              <span className="font-heading font-bold text-green-800">The End! 🎉</span>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex space-x-4">
                <div className="flex-1">
                  <MagicalInput
                    placeholder={state.isGenerating
                      ? "I'm crafting your story..."
                      : "Continue the story... (e.g., 'The character discovers a hidden door')"
                    }
                    value={userInput}
                ...
                >
                  ...
                  {state.isGenerating ? 'Creating...' : 'Continue'}
                </Button>
              </div>

              {/* Quick suggestions */}
              <div className="flex flex-wrap gap-2">
                <span className="text-xs text-muted-foreground mr-2">Quick ideas:</span>
                {[
                  ...
                  <button
                    ...
                    className="text-xs bg-purple-50 hover:bg-purple-100 text-purple-700 px-3 py-1 rounded-full transition-colors duration-200 border border-purple-200"
                  >
                    {suggestion}
                  </button>
                ))}
